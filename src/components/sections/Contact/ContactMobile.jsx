...
export default function ContactMobile() {
  return (
    <section id="contact-mobile" className="lg:hidden">
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#18132B] to-[#0F0B1F] px-4 py-8 mx-4">
        {/* soft glow */}
        <div
          aria-hidden
        ...
        <div className="relative z-10">
          ...
          <div className="rounded-2xl bg-white/[0.05] border border-white/10 p-6">
            <div className="w-14 h-14 mx-auto mb-4">
              <img
                src={frameGif}
                alt="Brand"
                className="w-14 h-14 object-cover shadow-[0_8px_24px_rgba(103,76,255,0.45)]"
                style={{
                  clipPath:
            ...
            <h3 className="text-2xl font-extrabold text-white text-center leading-snug">
              Still Have
              <br />
              A Questions?
            </h3>
            ...
            <div className="mt-5 flex items-center justify-center gap-3">
              <a
                href="#"
                className="p-2 rounded-full bg-white/[0.06] border border-white/10 text-white hover:bg-white/10 transition"
                aria-label="LinkedIn"
              >
              ...
              <span className="p-2 rounded-full bg-white/[0.06] border border-white/10 text-white text-[10px] font-semibold w-8 h-8 grid place-content-center">
                G
              </span>
              <a
                href="#"
          ...
          <form
            ...
            onSubmit={(e) => {
              ...
              console.log('Contact submit (mobile):', data);
              alert('Thanks! Your message has been sent.');
            }}
          >
            <div className="space-y-5">
              <div>
                <label htmlFor="m-name" className="block text-sm text-gray-300 mb-2">
                  Name
                </label>
                <input
                  id="m-name"
              ...
              <div>
                <label htmlFor="m-email" className="block text-sm text-gray-300 mb-2">
                  Email Address
                </label>
                <input
                  id="m-email"
              ...
              <div>
                <label htmlFor="m-phone" className="block text-sm text-gray-300 mb-2">
                  WhatsApp/Phone
                </label>
                <input
                  id="m-phone"
              ...
              <div className="relative">
                <label htmlFor="m-service" className="block text-sm text-gray-300 mb-2">
                  Which are You Looking for Support in?
                </label>
                <select id="m-service" name="service" className={selectBase} defaultValue="">
              ...
              <div>
                <label htmlFor="m-message" className="block text-sm text-gray-300 mb-2">
                  How Can We Help?
                </label>
                <textarea
                  id="m-message"
